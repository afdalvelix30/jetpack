...
class CatalogueRepository private constructor(private val remoteDataSources: RemoteDataSources) : CatalogueDataSources {
    companion object {
        @Volatile
        private var instance: CatalogueRepository? = null

        fun getInstance(remoteData: RemoteDataSources): CatalogueRepository =
            instance ?: synchronized(this) {
                instance ?: CatalogueRepository(remoteData).apply {
                    instance = this
                }
            }
    }
